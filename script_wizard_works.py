...
# ========== CONFIGURATION ==========
# REPLACE WITH YOUR NEW DEEPSEEK KEY FOR SCRIPT WIZARD
DEEPSEEK_API_KEY = "sk-fd10cfdc6006469ab692f714ab027a28"
...
async def generate_script(
    ...
    # Call DeepSeek API
    generated_script = generate_script_with_ai(script_type, audience, duration, style, voice, key_points)
    ...
    <article>
        <header style="text-align: center; margin-bottom: 2rem;">
            <hgroup>
                ...
                <p>Your AI-generated {TYPE_NAMES.get(script_type)} script</p>
            </hgroup>
        ...
        <div class="card">
            ...
            <div style="background: #f8fafc; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem; border-left: 3px solid #d1d5db;">
                <p style="margin: 0; color: #4b5563;">"{key_points}"</p>
            </div>
            ...
            <div style="margin-top: 0.5rem; text-align: center;">
                <small style="color: #666;">
                    <i class="fas fa-mouse-pointer"></i> <strong>Click the script above</strong> to select all text, then <strong>Ctrl+C</strong> to copy
                </small>
            </div>
            
            <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid #e5e7eb;">
                <p style="font-weight: 600; color: #374151; margin-bottom: 0.75rem;">How to use this script:</p>
                <ol style="margin: 0; padding-left: 1.5rem; color: #4b5563;">
                    <li style="margin-bottom: 0.5rem;"><strong>Click</strong> the script above (it will auto-select)</li>
                    <li style="margin-bottom: 0.5rem;"><strong>Copy</strong> with Ctrl+C (Cmd+C on Mac)</li>
                    <li style="margin-bottom: 0.5rem;"><strong>Paste</strong> into your script editor or teleprompter</li>
                    <li>Modify as needed and start recording!</li>
                </ol>
            </div>
        </div>
        
        <div class="grid" style="grid-template-columns: repeat(2, 1fr); gap: 1rem; margin-top: 3rem;">
            <a href="/script-wizard/step/1" class="primary" style="text-align: center; padding: 1rem;">
    ...
    return script_layout("Generated Script", content, step=7)
